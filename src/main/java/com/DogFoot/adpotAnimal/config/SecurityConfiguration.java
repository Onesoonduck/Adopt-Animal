    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            .authorizeHttpRequests((auth)->auth
                ...
                .requestMatchers("/css/**","/js/**","/header/index.html","signup.html","main.html","login.html","login","signup","admin_user.html").permitAll()    // css, js, html
                .requestMatchers("users/signup","/","users/login").permitAll()
                .requestMatchers("users/{id}","users/usersEdit").permitAll()
                .requestMatchers("users/api/usersTable").permitAll()
